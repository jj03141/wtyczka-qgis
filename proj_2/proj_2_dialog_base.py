...
class Ui_projekt2DialogBase(object):
    def setupUi(self, projekt2DialogBase):
        ...
        self.line.setGeometry(QtCore.QRect(190, 20, 20, 151))
        ...
        self.pushButton_poligon.setGeometry(QtCore.QRect(20, 200, 131, 31))
        self.pushButton_poligon.setObjectName("pushButton_poligon")
        self.label_poligon = QtWidgets.QLabel(projekt2DialogBase)
        self.label_poligon.setGeometry(QtCore.QRect(360, 200, 121, 41))
        ...
        self.pushButton_geometria = QtWidgets.QPushButton(projekt2DialogBase)
        self.pushButton_geometria.setGeometry(QtCore.QRect(180, 200, 141, 31))
        self.pushButton_geometria.setObjectName("pushButton_geometria")
        self.pushButton_pole_poligonu = QtWidgets.QPushButton(projekt2DialogBase)
        self.pushButton_pole_poligonu.setGeometry(QtCore.QRect(40, 140, 141, 31))
        self.pushButton_pole_poligonu.setObjectName("pushButton_pole_poligonu")
        self.label_pole_poligonu = QtWidgets.QLabel(projekt2DialogBase)
        self.label_pole_poligonu.setGeometry(QtCore.QRect(240, 140, 211, 31))
        self.label_pole_poligonu.setText("")
        self.label_pole_poligonu.setObjectName("label_pole_poligonu")
    ...
    def retranslateUi(self, projekt2DialogBase):
        ...
        self.pushButton_geometria.setText(_translate("projekt2DialogBase", "Dodaj geometrię"))
        self.pushButton_pole_poligonu.setText(_translate("projekt2DialogBase", "Pole poligonu"))
